...
export class RealtimeAPI extends RealtimeEventHandler {
  ...
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug } = {}) {
    super();
    this.defaultUrl = 'wss://whywa-m1vsn982-eastus2.openai.azure.com/openai/realtime?api-version=2024-10-01-preview&deployment=gpt-4o-realtime-preview';
   ...
   */
  async connect({ model } = { model: 'gpt-4o-realtime-preview-1001' }) {
    ...
    if (globalThis.document) {
      ...
      const ws = new WebSocket(
        'wss://whywa-m1vsn982-eastus2.openai.azure.com/openai/realtime?api-version=2024-10-01-preview&deployment=gpt-4o-realtime-preview',
        [],
        {
